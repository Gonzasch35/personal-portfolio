    ...
    <footer className={style.footer}>
      ...
      <div className={style.container}>
        ...
        <div className={style.redes}>
              ...
              <li className={style.icon}>
                <a href="mailto:gonza.sch35@gmail.com" target="_blank"><svg width="15" height="15" class="mail h-p-0-lg h-mb-3-lg" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
